        ...
        {/* Remember Me */}
          <View style={{ marginTop: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              <Text style={{ fontSize: 13, fontFamily: 'Regular-Sen', color: colors.secondaryTxt }}>Remember me</Text>
            </View>
          ...
          <View style={{ width: '100%', alignItems: "center", justifyContent: 'center' }}>
            ...
            <Text 
              ...
              onPress={() => alert("Implement navigation to Sign Up page")}>SIGN UP</Text>
            </Text>
          </View>
